  ...
  const versions = [
    {
      version: '1.3.4',
      date: '11 мая 2026',
      title: 'Оптимизация коммуникаций и стабильность',
      isCurrent: true,
      changes: [
        'Чат: Исправлена логика уведомлений при управлении группами (теперь корректно отображается «Участники добавлены» вместо «Группа создана»).',
        'Чат: Глубокая оптимизация производительности — устранены фризы при прокрутке и вводе сообщений в больших чатах.',
        'Чат: Добавлена возможность покинуть групповой чат через контекстное меню.',
        'Чат: Улучшен режим приватности — функция «Скрыть» заменена на полноценное управление уведомлениями («Без звука») с наглядной индикацией.',
        'Чат: Исправлена синхронизация счетчиков непрочитанных сообщений в групповых обсуждениях.',
        'Чат: Реализовано автоматическое закрытие панели эмодзи при отправке сообщения или нажатии Enter.',
        'Чат: Исправлено отображение аватаров — устранена ошибка вывода текста «null» вместо иконок групп.',
        'Система: Проведена полная диагностика кода, исправлены ошибки типизации и импортов, повышена стабильность WebSocket-соединения.'
      ]
    },
    {
      version: '1.3.3',
